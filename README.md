...
<p align="center"><em>Status: <strong>v0.21.0 — A Physical World</strong> · one connected Arthurian campaign (the Sword in the Stone → Mount Badon → Defend Camelot → Camlann → the Lady of the Lake, plus the Ford &amp; challenge rooms and a Three Kingdoms 三國無雙 bonus) that you can now BREAK: smashable barrels, pots, haystacks and explosive fire-barrels that shatter into flying debris; the stone deflects enemy arrows (a shield as well as a club); denser swarming armies kept smooth; a pause menu to return to the lobby from any fight; boss-gated wins; harder, fairer combat; a responsive lobby with unlock progression; victory/defeat fanfares and a "THE LEGEND IS COMPLETE" finale. Built from the reusable Campaign / BattleMap / Breakable / Impact / PauseMenu / art / terrain / formation / objective / ability modules, playable on desktop and on a phone in landscape</em></p>
